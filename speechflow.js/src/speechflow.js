...
export class SpeechFlowTTS {
  /**
   * Create a new SpeechFlowTTS instance.
  ...
  /**
   * Load a SpeechFlowTTS model from the Hugging Face Hub.
   ...
   * @returns {Promise<SpeechFlowTTS>} The loaded model
   */
