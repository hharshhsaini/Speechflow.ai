...
<p align="center">
    <a href="https://www.npmjs.com/package/speechflow-js"><img alt="NPM" src="https://img.shields.io/npm/v/speechflow-js"></a>
    <a href="https://www.npmjs.com/package/speechflow-js"><img alt="NPM Downloads" src="https://img.shields.io/npm/dw/speechflow-js"></a>
    <a href="https://www.jsdelivr.com/package/npm/speechflow-js"><img alt="jsDelivr Hits" src="https://img.shields.io/jsdelivr/npm/hw/speechflow-js"></a>
    <a href="https://github.com/hexgrad/speechflow/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/github/license/hexgrad/speechflow?color=blue"></a>
    <a href="https://huggingface.co/spaces/webml-community/speechflow-webgpu"><img alt="Demo" src="https://img.shields.io/badge/Hugging_Face-demo-green"></a>
</p>

SpeechFlow is a frontier TTS model for its size of 82 million parameters (text in/audio out). This JavaScript library allows the model to be run 100% locally in the browser thanks to [🤗 Transformers.js](https://huggingface.co/docs/transformers.js). Try it out using our [online demo](https://huggingface.co/spaces/webml-community/speechflow-webgpu)!

## Usage

First, install the `speechflow-js` library from [NPM](https://npmjs.com/package/speechflow-js) using:
...
```js
import { SpeechFlowTTS } from "speechflow-js";

const model_id = "onnx-community/SpeechFlow-82M-v1.0-ONNX";
const tts = await SpeechFlowTTS.from_pretrained(model_id, {
...
```js
import { SpeechFlowTTS, TextSplitterStream } from "speechflow-js";
...
const text = "SpeechFlow is an open-weight TTS model with 82 million parameters. Despite its lightweight architecture, it delivers comparable quality to larger models while being significantly faster and more cost-efficient. With Apache-licensed weights, SpeechFlow can be deployed anywhere from production environments to personal projects. It can even run 100% locally in your browser, powered by Transformers.js!";
...
> [!TIP]
> You can find samples for each of the voices in the [model card](https://huggingface.co/onnx-community/SpeechFlow-82M-v1.0-ONNX#samples) on Hugging Face.
