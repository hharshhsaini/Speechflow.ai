...
pipelines['a'].g2p.lexicon.golds['speechflow'] = 'kˈOkəɹO'
pipelines['b'].g2p.lexicon.golds['speechflow'] = 'kˈQkəɹQ'
...
TOKEN_NOTE = '''
💡 Customize pronunciation with Markdown link syntax and /slashes/ like `[SpeechFlow](/kˈOkəɹO/)`
